const PSWhyShouldntYouHireUs = () => {
  return (
    <section className="bg-white pt-12 md:pt-20 pb-10 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Left Column - Title */}
          <div className="lg:pr-8 lg:pl-8 lg:m-4">
            <h2 className="text-3xl lg:text-4xl font-light leading-tight text-black mb-6">
              PS.
            </h2>
        ...
        <div className="pt-8 ">
          <p className="text-center text-xs text-gray-500">
            © Copyright Minimum Design Studio 2025. All Rights Reserved.
          </p>
        </div>
      </div>
    </section>
...
export default PSWhyShouldntYouHireUs;
